  ...
  const sendMessage = async (message) => {
    try {
      ...
      const response = await axios.post(
        'https://backend.mamapesa.com/accounts/chat/',
        { query: message },
        {
          headers: {
  ...
  return (
    <div style={styles.pageContainer}>
      <Container className="app animate-fadeIn" style={styles.chatContainer}>
        <header className="bg-maroon text-white p-3" style={styles.chatHeader}>
          ...
          <div className="border rounded p-3 mb-3 flex-grow-1" style={styles.chatBody} ref={scrollRef}>
            {!conversationStarted && (
              <div className="text-center">
                ...
                <p className="text-muted">
                  Welcome to MamaPesa AI, your financial assistant. Feel free to ask anything. 
                  Type /start to begin interacting with MamaPesa Assistant.
                </p>
              </div>
            )}
            ...
            {conversationStarted &&
              ...
              messages.map((message, index) => (
                ...
                >
                  <div className={`p-3 rounded ${message.isUser ? 'bg-light' : 'bg-secondary text-white'}`}>
                    {message.file ? (
                      <div>
